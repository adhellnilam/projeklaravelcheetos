! function (t) {
    ...
    function n(t, e) {
        if (t.checked = e, !0 === e) t.closest("tr").classList.add("selected");
        else {
    ...
    (function (n) {
        ...
        ! function (n, l) {
            ...
            var t = void 0 !== n ? n : this || window,
                ...
                dt = /\b(top|bottom|left|right)+/,
                ht = 0,
                pt = "fixed-top",
                vt = "fixed-bottom",
                mt = "Webkit" + et in o.style || et[tt]() in o.style,
                yt = "Webkit" + et in o.style ? "Webkit" [tt]() + et + "End" : et[tt]() + "end",
                bt = function (t) {
                ...
                Et = function (t, n) {
                    ...
                    if ("." === o) {
                        for (; t && t !== e; t = t[Z])
                            if (null !== At(n, t[Z]) && xt(t, i)) return t
                    } else if ("#" === o)
                        for (; t && t !== e; t = t[Z])
                            if (t.id === i) return t;
                    return !1
                ...
                Ot = function () {
                    return {
                        y: t.pageYOffset || o[I],
                        x: t.pageXOffset || o.scrollLeft
                    }
                },
                Nt = function (t, n, i, a) {
                    var l, r, s, c, u, f, d = n[j],
                        h = n[M],
                        p = o[O] || e.body[O],
                        v = o[N] || e.body[N],
                        m = t[V](),
                        y = a === e.body ? Ot() : {
                            x: a.offsetLeft + a.scrollLeft,
                            y: a[S] + a[I]
                        },
                        b = m.right - m.left,
                        g = m[ut] - m.top,
            ...
            var Bt = function (n, i) {
                n = At(n), i = i || {};
                var a = n[z]("data-interval"),
                    l = i[E],
                    r = "false" === a ? 0 : parseInt(a) || 5e3,
                    c = n[z]("data-pause") === H || !1,
                    u = "true" === n[z](h) || !1,
                    f = "carousel",
                    d = "paused",
                    p = "direction",
                ...
                var y = this,
                    ...
                    k = T[$],
                    L = this[p] = rt,
                    C = Tt(n, f + "-control-prev")[0],
                    S = Tt(n, f + "-control-next")[0],
                    I = At(".carousel-indicators", n),
                    O = I && I[K]("LI") || [],
                    M = function () {
            ...
            var Pt = function (n, i) {
                ...
                if (xt(n, "modal") && (n = null), s) {
                    ...
                    var m, y, b, g, E = this,
                        k = null,
                        L = Tt(o, pt).concat(Tt(o, vt)),
                        C = function () {
                            var n, o = t.getComputedStyle(e.body),
                                i = parseInt(o[f], 10);
                            if (m && (e.body.style[f] = i + b + "px", L[$]))
                                for (var a = 0; a < L[$]; a++) n = t.getComputedStyle(L[a])[f], L[a].style[f] = parseInt(n) + b + "px"
                        },
                        S = function () {
                            m = e.body[O] < function () {
                                var e = o[V]();
            ...
            var Ht = function (n, o) {
                n = At(n), o = o || {};
                var i = n[z]("data-trigger"),
                    a = n[z](y),
                    l = n[z](g),
                    r = n[z]("data-dismissible"),
                    s = n[z]("data-delay"),
                    c = n[z](b),
                    u = "popover",
                    f = "template",
                    d = "trigger",
                    h = "dismissible",
                    p = '<button type="button" class="close">×</button>',
                    m = At(o[C]),
                    w = At(c),
                    x = Et(n, ".modal"),
                    T = Et(n, "." + pt),
                ...
                if ((n = n || {})[A] || o) {
                    ...
                    var w = function (t) {
                        var n = u[t],
                            o = d[t],
                            i = n[Z][Z],
                            l = xt(i, "dropdown") && i[K]("A")[0],
                            r = v && o[V](),
                            s = xt(n, it) || !1,
                            f = (v ? r.top + a : o[S]) - c,
                            h = v ? r[ut] + a - c : d[t + 1] ? d[t + 1][S] - c : e[B],
                            p = a >= f && h > a;
                        if (!s && p) xt(n, it) || (gt(n, it), l && !xt(l, it) && gt(l, it), It.call(e, "activate", "scrollspy", u[t]));
                        else if (p) {
                            if (!p && !s || s && p) return
            ...
            var Ft = function (t, e) {
                var n = (t = At(t))[z]("data-height"),
                    o = "height",
                    i = "isAnimating";
                e = e || {}, this[o] = !!mt && (e[o] || "true" === n);
                var a, r, s, c, u, f, d, h = this,
                    p = Et(t, ".nav"),
                    v = !1,
                    m = p && At(".dropdown-toggle", p),
                    y = function () {
