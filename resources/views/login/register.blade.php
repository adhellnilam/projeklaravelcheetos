...
<head>
   ...
   <title>Cheetos | Registration</title>
...
<body>
   <div class="card w-25 p-3 mt-4" style="margin-left: 37%;">
      <div class="card-body">
        <a class="btn btn-labeled btn-block text-left btn-sm btn-facebook" href="/auth/google" style="padding-left: 80px;">
          <span class="btn-label">
            <img src="google.png" alt="" srcset="">
          </span>
          Login with Google
        </a>
        <a href="/"><button type="submit" class="btn btn-sm btn-block btn-primary">Log In</button>
        </a>
      </div>
