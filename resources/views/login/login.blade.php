...
<body>
   <div class="card w-25 p-3" style="margin-left: 37%; margin-top: 110px; ">
      <div class="card-body">
        <a class="btn btn-labeled btn-block text-left btn-sm btn-facebook" href="/auth/google" style="padding-left: 75px;">
          <span class="btn-label">
            <img src="google.png" alt="" srcset="">
          </span>
          Login with Google
        </a>
        <a href="/registerUser"><button type="submit" class="btn btn-sm btn-block btn-primary">Registration</button>
        </a>
      </div>
